...
from providers.registry import PROVIDER_DESCRIPTORS, ProviderOverrides, ProviderRegistry
...
def resolve_provider(
    ...
    *,
    ...
    if app is not None:
        ...
        return _resolve_with_registry(reg, provider_type, settings, overrides=overrides)
    return _resolve_with_registry(
        ProviderRegistry(_providers), provider_type, settings, overrides=overrides
    )
...
def _resolve_with_registry(
    ...
    *,
    ...
    try:
        provider = registry.get(provider_type, settings, overrides=overrides)
